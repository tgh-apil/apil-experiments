...
<button on:click={SuggestionLoad}>Feedback Page</button>
<button on:click={openNav}>Controls</button>

<div id="myNav" class="overlay">
    <a href="javascript:void(0)" class="closebtn" on:click={closeNav}></a>
    <div class="overlay-content">
      <a href="javascript:;"><img src="https://img.icons8.com/color/50/000000/mouse-right-click.png"/>Hold Right Button to Turn</a>
      <a href="javascript:;"><img src="https://img.icons8.com/fluency/48/000000/mouse-scrolling.png"/>Use Mouse Wheel to Zoom</a>
      <a href="javascript:;"><img src="https://img.icons8.com/color/48/000000/mouse-left-click.png"/>Double Left Click to Add Marker</a>
      <a href="javascript:;" on:click={closeNav}><img src="https://img.icons8.com/office/40/000000/exit.png"/>Exit Controls</a>
    </div>
  </div>
